...
const Contact = () => {
    ...
    const sendEmail = () => {
        window.location = "mailto:ginger23333@gmail.com";
    };
    return (
        <motion.div
            ref={ref}
        ...
        >
            ...
            <div className="mt-6 flex space-x-3 text-2xl justify-center items-center text-gray-300">
                ...
                <a
                    href="https://www.instagram.com/ginger_linjiang/?hl=en"
                    target="_blank"
                    rel="noreferrer noopener"
                >
                    <FontAwesomeIcon
                ...
                <a
                    href="https://github.com/Ginger000"
                    target="_blank"
                    rel="noreferrer noopener"
                >
                    <FontAwesomeIcon
                ...
                <a
                    href="https://leetcode.com/ginger23333/"
                    target="_blank"
                    rel="noreferrer noopener"
                >
                    <Icon
                ...
                <a
                    href="https://issuu.com/ginger_linjiang/docs/lin_jiang_s_portfolio"
                    target="_blank"
                    rel="noreferrer noopener"
                >
                    <Icon
