...
const Hero = ({ hero }) => {
    if (hero) {
        const { content1, name, content2, content3, content4 } =
            hero.attributes;
        ...
        return (
            ...
            >
                <motion.div variants={item}>
                    <ReactMarkdown className="text-hyper-cyan font-light 2xl:text-lg">
                        {content1}
                    </ReactMarkdown>
                </motion.div>
                ...
                <motion.h1
                    variants={item}
                    className="text-3xl sm:text-5xl 2xl:text-7xl font-bold text-ho-pink"
                >
                    {name}
                </motion.h1>
                <motion.h1
                    variants={item}
                    className="text-3xl sm:text-5xl 2xl:text-7xl font-semibold text-ho-pink opacity-50 relative -z-10"
                >
                    {content2}
                </motion.h1>
                <motion.p
                    variants={item}
                    className=" w-full md:w-128 2xl:text-lg text-gray-100 font-normal"
                >
                    {content3}
                </motion.p>
                <motion.p
